...
description: Mejores prácticas de endurecimiento de servidores CSDOCS.
---

import { Steps, Tabs, TabItem, Card } from '@astrojs/starlight/components';

# 🛡️ Seguridad y Acceso SSH

Proteger el servidor es el primer paso antes de desplegar cualquier código de CSDOCS en producción.

---

## 🔑 Acceso via Llave Pública (Recomendado)

Desactiva el acceso por contraseña para prevenir ataques de fuerza bruta.
...
## 🛡️ Fail2Ban (Protección contra Intrusos)
